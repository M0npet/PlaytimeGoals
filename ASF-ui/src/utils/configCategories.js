...
const botCategories = [
  ...
  { name: Vue.i18n.translate('customization'), fields: ['RemoteCommunication', 'SteamMasterClanID', 'UserInterfaceMode', 'GamingDeviceType', 'MachineName', 'OnlinePreferences', 'OnlineFlags', 'RedeemingPreferences', 'CustomGamePlayedWhileFarming'] },
